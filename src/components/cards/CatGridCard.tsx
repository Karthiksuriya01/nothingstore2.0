...
import { CAT_BG, C, sm } from '../../constants/theme';
...
export default function CatGridCard({ p, cart, addToCart, dec, floatMap, onOpen }: CatGridCardProps) {
    ...
    return (
        ...
        >
            <div style={{
                height: 90, background: CAT_BG[p.cat] || C.primaryBg,
                display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative',
            }}>
                <ProductImage id={p.id} size={66} radius={10} />
                {fresh && (
                    <div style={{
            ...
            <div style={{ padding: '9px 10px 11px' }}>
                ...
                <p style={{ fontSize: 10, color: C.textLight, marginBottom: 6, fontWeight: 500 }}>{p.unit}</p>
